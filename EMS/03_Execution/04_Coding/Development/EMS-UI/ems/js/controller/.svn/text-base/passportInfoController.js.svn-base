...
//            vm.visaInfoList.push(visaInfo);
                    ...
                    initData().then(function() {
                        ...
                        employeeBasicInfoService.getPassportInfoByEmployeeIdAndDate(inputObj).then(function success(result) {
                            ...
                            vm.passportInfo = {
                                ...
                                issuingAuthority : result.passportIssuanceAuthority,
        	...
        	if(!invalid) {
                    ...
                    passportInfo.passportIssuanceAuthority = vm.passportInfo.issuingAuthority;
            ...
            vm.validateInfo = function () {
               ...
               if(vm.passportInfo.nationality === null ||
                       vm.passportInfo.nationality === undefined ||
