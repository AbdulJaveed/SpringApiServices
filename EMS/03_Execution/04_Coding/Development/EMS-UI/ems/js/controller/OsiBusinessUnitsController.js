...
OsiBusinessUnitsController.$inject = ['$q', '$scope', '$rootScope', '$window', '$location',
    '$http', '$localStorage', 'OsiBusinessUnitsService', 'FlashService', '$timeout','appConstants'];
function OsiBusinessUnitsController($q, $scope, $rootScope, $window, $location, $http,
        $localStorage, OsiBusinessUnitsService, FlashService, $timeout,appConstants) {
    var vm = this;
...
$scope.editSelectedRowDetails = function(OsiBusinessUnits){
 ...
 $scope.continuesave = false;}else if(!$scope.OsiBusinessUnits.buLongName){
 $rootScope.isTrascError = true;
