...
$scope.editSelectedRowDetails = function(OsiJobCodes){
    ...
    function validateDuplicateJobEntry(OsiJobCodes){
    	if($scope.headername=='Edit Job Code' && $scope.editJobName!=null && $scope.editJobName.toUpperCase()== OsiJobCodes.jobCodeName.toUpperCase() ){
    		//Do Nothing
    	}
    	if($scope.headername =='Create Job Code' && $scope.editJobName!=null  && $scope.editJobName.toUpperCase()== OsiJobCodes.jobCodeName.toUpperCase()){
    ...
    $scope.saveOsiJobCodes = function (OsiJobCodes) {
        ...
        if(!$scope.OsiJobCodes.jobCodeName){ 
        	...
        	$rootScope.isTrascError = true;
        	 FlashService.Error('Job Code already Exists'); 
        	 $scope.continuesave = false;
