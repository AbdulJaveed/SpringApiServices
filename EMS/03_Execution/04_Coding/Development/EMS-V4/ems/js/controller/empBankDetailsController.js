(function() {
	...
	empBankDetailsController.$inject = [ 'configData', '$timeout','appConstants', '$location', '$window', '$scope', '$rootScope', 'empBankDetailsService', 'SharedDataService', '$localStorage', '$uibModal', '$route', '$http'];
	function empBankDetailsController(configData, $timeout,appConstants, $location, $window, $scope, $rootScope, empBankDetailsService, SharedDataService, $localStorage, $uibModal, $route,  $http) {
        var vm = this;
            ...
            empBankModalInstance.result.then(function (data) {
				...
				vm.init = function(){
                    ...
                    $http.get(
                        ...
                        + $rootScope.profileAcessHR.bankFuncId+'/'+$rootScope.globals.userDTO.id).success(function(response) {
