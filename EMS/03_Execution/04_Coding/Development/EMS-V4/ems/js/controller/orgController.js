...
angular.module('orgHierarchyController', [])
 ...
 $scope.getEmployeeProfile = function(empId){
   ...
   $localStorage.currentEmployeeId = empId;
  ...
  //	d3.kodama.theme("kodama")
    ...
    $scope.employeeInfo="<b>Employee Information</b> <br><br><br>"
        return {
            title: '<b>Employee Information</b>',//$scope.employeeInfo,//'Employee Information',
            items: [
                    ...
                    { title: 'Date of Hire', value: d.dateHired}
...
/*    console.log("window height"+$(window).height());
  ...
  //  	  .attr("xlink:href", "images/avatar.png")
    ...
    nodeUpdate.select("circle")
        .attr("r", 4.5)
        //.style("fill", function(d) { return d._children ? "lightsteelblue" : "#fff"; });
        .style("fill", function(d) { return (d.id == employeeId) ? "blue" : "#fff"; });

    nodeUpdate.select("text")
        .style("fill-opacity", 1)
        .style("fill", function(d) { return (d.id == employeeId) ? "blue" : "#000"; });
