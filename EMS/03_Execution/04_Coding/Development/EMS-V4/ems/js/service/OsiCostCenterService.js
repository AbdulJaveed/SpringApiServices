(function () {
    ...
    function OsiCostCenterService($http, $cookieStore, $rootScope, $timeout, $localStorage, $sessionStorage,configData,$q) {
        ...
        service.getCCGradesHistory = getCCGradesHistory;
        ...
        function getCCGradesHistory(ccId, orgId, gradeId){
            return $http.get(configData.url+'crud/'+domain+'/getOsiCCGradesHistory/'+ccId+'/'+orgId+'/'+gradeId).then(handleSuccess, handleError('Error getting grades history'));
        }
