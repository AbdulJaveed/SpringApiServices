...
public class ActiveDirectory {
	...
	private static final String ldapURL = "ldap://192.168.32.22:389";
	//private static final String ldapURL = "ldap://192.168.32.216:389";
   ...
   */
    public static LdapContext getConnection(String username, String password, String domainName, String serverName) throws NamingException {
        ...
        props.put(Context.SECURITY_PRINCIPAL, username+ "@osius.com");
        ...
        try{
            ...
            throw new NamingException("Failed to authenticate " + username + ((serverName==null)? "" : " through " + serverName));
        }
    }
   ...
   */
    ...
    public String authenticate(String username, String password) throws NamingException {
		System.out.println("ActiveDirectory called with user: "+username);
		LdapContext context = getConnection(username, password);
		User user = getUser(username, context);
		return user.getUserPrincipal();
    }
    
    public static void main(String[] args) throws NamingException {
	//	System.out.println(new ActiveDirectory().authenticate("rdonepudi", "######"));
		System.out.println(new ActiveDirectory().getUsers(new ActiveDirectory().getConnection("rdonepudi", "####")));
	}
