...
/**
 * Class for Manging the osiSubpractice grades Dto.
 * 
 * @author jkolla
 *
 */
public class OsiSubPracticeGradesHistoryDto implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1347974679052662480L;
