...
public class OsiEmployees implements Serializable {
	...
	// For Overall Search for Sales Team
	private String locationName;
	private String projects;
	
	private OsiOrgAddressesDTO mailAddress;
	private OsiOrgAddressesDTO permanentAddress;
	@Override
	...
	public OsiEmployees(Integer employeeId, String employeeNumber, String firstName, String lastName, String middleName,
			...
			Integer attachmentId ,OsiContacts osiEmployeeContacts, Double totalExp, String userName) {
		super();
	...
	public OsiOrgAddressesDTO getMailAddress() {
		return mailAddress;
	}

	public void setMailAddress(OsiOrgAddressesDTO mailAddress) {
		this.mailAddress = mailAddress;
	}

	public OsiOrgAddressesDTO getPermanentAddress() {
		return permanentAddress;
	}

	public void setPermanentAddress(OsiOrgAddressesDTO permanentAddress) {
