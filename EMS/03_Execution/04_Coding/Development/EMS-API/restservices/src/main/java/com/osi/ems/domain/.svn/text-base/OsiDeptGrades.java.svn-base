...
*/
@Entity
@Table(name = "osi_dept_grades")
public class OsiDeptGrades implements java.io.Serializable {
	...
	public OsiDeptGrades() {
	}

	@Id
	@GeneratedValue(strategy = IDENTITY)
	@Column(name = "dept_grade_id", unique = true, nullable = false)
