...
public class OsiEmployeesDTO implements Serializable {
	...
	public String toString() {
		return "OsiEmployees [employeeId=" + employeeId + ", employeeNumber=" + employeeNumber + ", firstName="
				...
				+ ", effectiveStartDate=" + effectiveStartDate + ", effectiveEndDate=" + effectiveEndDate + ", orgId="
				...
				+ ", lastUpdateDate=" + lastUpdateDate + ", attachmentId=" + attachmentId + "osiEmployeeContacts = "+osiEmployeeContacts+"]";
	}
	
	public OsiEmployeesDTO() {
		
	}

	public OsiEmployeesDTO(Integer employeeId, String employeeNumber, String firstName, String lastName, String middleName,
			String fullName, String title, String suffix, String prefix, String employeeType, String applicantNumber,
			String dateOfBirth, String startDate, String effectiveStartDate, String effectiveEndDate, Integer orgId,
			...
			String resumeExists, String resumeLastUpdated, Integer resumeId, Integer secondPassportExists,
			...
			Integer attachmentId ,OsiContacts osiEmployeeContacts, String userName) {
		super();
